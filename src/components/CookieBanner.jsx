 ...
 * Informa o uso de Hotjar, Google Analytics GA4 e Google Tag Manager,
 * e oferece aceitar ou recusar antes de qualquer coleta de dados.
 *
...
const CookieBanner = ({ onAccept, onDecline, onPrivacyOpen }) => {
  ...
  const tools = [
    ...
    { name: "Google Tag Manager",   desc: "Gerenciador de tags"  },
  ];
    ...
    <>
      ...
      >
        ...
        <p style={{
          ...
          <strong style={{ color: "var(--fg)" }}>Google Analytics (GA4)</strong> e{" "}
          <strong style={{ color: "var(--fg)" }}>Google Tag Manager</strong> para
